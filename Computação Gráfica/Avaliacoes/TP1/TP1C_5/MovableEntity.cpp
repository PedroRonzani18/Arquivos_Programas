...
MovableEntity::MovableEntity
        (int displayListModel, double hp, GLboolean onScreen, OrderedPair midPoint, OrderedPair max, OrderedPair min)
        :
        Entity(displayListModel, hp, onScreen, midPoint, max, min)
{
