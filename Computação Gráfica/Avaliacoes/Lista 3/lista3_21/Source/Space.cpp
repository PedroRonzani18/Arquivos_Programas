...
void Space::initializePlanets() // fazer engine que calcule essas velocidades em unidades glut a partir do raio, periodo e distância do planeta, e estatem influenciados por um alpha
{
    ...
    planetas.push_back(Planet::createPlanetTemplate(texturesId[0], 1, 0, 0.4, 2.5, 88, 30));
    planetas.push_back(Planet::createPlanetTemplate(texturesId[1], 1, 1, 0.4, 4.5, 225, 30));
    planetas.push_back(Planet::createPlanetTemplate(texturesId[2], 1, 1, 0.4, 6.5, 365, 30));
    planetas.push_back(Planet::createPlanetTemplate(texturesId[3], 1, 2, 0.4, 8.5, 686, 30));
    planetas.push_back(Planet::createPlanetTemplate(texturesId[4], 1, 3, 0.4, 10.5, 4328, 30));
    planetas.push_back(Planet::createPlanetTemplate(texturesId[5], 1, 3, 0.4, 12.5, 10752, 30));
    planetas.push_back(Planet::createPlanetTemplate(texturesId[6], 1, 3, 0.4, 14.5, 30663, 30));    
    planetas.push_back(Planet::createPlanetTemplate(texturesId[7], 1, 3, 0.4, 16.5, 601480000, 30));
