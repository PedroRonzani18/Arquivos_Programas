...
int colisaoGeral(int e1, int e2)
{
    // Se não ocorre colisão, retorna 0
        if(entityList[e1].x_max * cos(entityList[0].angulo) + entityList[e1].ponto_c_x <= entityList[e2].x_min + entityList[e2].ponto_c_x) return 0;
        if(entityList[e1].x_min * cos(entityList[0].angulo) + entityList[e1].ponto_c_x >= entityList[e2].x_max + entityList[e2].ponto_c_x) return 0;
        if(entityList[e1].y_max * sin(entityList[0].angulo) + entityList[e1].ponto_c_y <= entityList[e2].y_min + entityList[e2].ponto_c_y) return 0;
        if(entityList[e1].y_min * sin(entityList[0].angulo) + entityList[e1].ponto_c_y >= entityList[e2].y_max + entityList[e2].ponto_c_y) return 0;
