...
typedef struct ENTIDADE
{
    ...
    double x_resize, y_resize; // Escalas de redimensionamento das coordenadas. // Coordenadas do ponto central.
...
void movimentacaoJogador()
{
    ...
    entityList[0].centro.x += (on_off[0] - on_off[1]) * cos(aux_angle);
    entityList[0].centro.y += (on_off[0] - on_off[1]) * sin(aux_angle);
