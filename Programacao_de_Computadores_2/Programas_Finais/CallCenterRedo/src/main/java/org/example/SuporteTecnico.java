...
public class SuporteTecnico {
    ...
    public SuporteTecnico() {
        ...
        inicializaSolucao();
        inicializaSolucaoPadrao();
    }


    public void inicializaSolucao(){
    ...
    public void inicializaSolucaoPadrao(){
    ...
    public String buscaSolucao(HashSet<String> palavras){
        for(String i: palavras){
            if(bancoSolucao.containsKey(i))
                return bancoSolucao.get(i);
        }
        return null;
    }

    public String buscaSolucaoPadrao(int contador){
        int posicao = gerador.nextInt(10)%contador;

        String aux = respostaPadrao.get(posicao);
        respostaPadrao.remove(posicao);
        return aux;
    }
}
